// simpleserver.m -- listen on a port and print any bytes that come throngh
...
int main(int argc, char *argv[]) {
	...
	if (useIPv6)
		...
		*/
	fd = socket(argc > 1 ? AF_INET6 : AF_INET, SOCK_STREAM, 0);
...
static void AcceptClientFromSocket(int listenFd) {
	...
	// Get the port and a ponter to the network address.
